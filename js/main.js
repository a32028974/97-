// /RECETAS/js/main.js — v2025-09-05 (full rebuild)
// UI general + progreso + fechas + cámara + búsquedas + totales + graduaciones + historial mini
...
function recalcularFechaRetiro(){
  ...
  const sel = $('entrega-select'); // <- select fijo (7, 3, 15)
  ...
  if(form){
    form.addEventListener('submit', async (e)=>{
      ...
      try{
        ...
        // limpiarFormulario() puede llamarse desde guardar.js si corresponde
      } catch (err){
        console.error(err);
